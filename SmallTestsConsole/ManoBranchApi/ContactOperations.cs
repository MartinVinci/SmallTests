...
{
    internal partial class ContactOperations : IServiceOperations<ManoBranchApi>, IContactOperations
    {
        /// <summary>
        /// Initializes a new instance of the ContactOperations class.
        /// </summary>
        /// <param name='client'>
        /// Reference to the service client.
        /// </param>
        internal ContactOperations(ManoBranchApi client)
        {
            this._client = client;
        }
        
        private ManoBranchApi _client;
        
        /// <summary>
        /// Gets a reference to the SmallTestsConsole.ManoBranchApi.
        /// </summary>
        public ManoBranchApi Client
        {
        ...
        /// Cancellation token.
        /// </param>
        public async Task<HttpOperationResponse<IList<Contact>>> GetByIdWithOperationResponseAsync(int id, CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // Tracing
            bool shouldTrace = ServiceClientTracing.IsEnabled;
            string invocationId = null;
